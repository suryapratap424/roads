...
})()(
  {
    ...
    4: [
      function (_dereq_, module, exports) {
        ...
        var grammars = { fr: grammarFr, ru: grammarRu };
        var abbreviations = {
          bg: abbreviationsBg,
          ca: abbreviationsCa,
          da: abbreviationsDa,
    ...
    18: [
      function (_dereq_, module, exports) {
        module.exports = {
          abbreviations: { sankta: "s:ta", gamla: "G:la", sankt: "s:t" },
              ...
              formatDistance: function (d, sensitivity) {
                ...
                if (this.options.units === "imperial") {
                  ...
                  if (yards >= 1e3) {
                    ...
                    data = { value: round(yards, sensitivity), unit: un.yards };
                  }
                } else {
              ...
              options: {
                ...
                waypointNameFallback: function (latLng) {
                  var ns = latLng.lat < 0 ? "S" : "N",
                    ew = latLng.lng < 0 ? "W" : "E",
                    lat = (
                      Math.round(Math.abs(latLng.lat) * 1e4) / 1e4
                    ).toString(),
                    lng = (
                      Math.round(Math.abs(latLng.lng) * 1e4) / 1e4
                    ).toString();
